...
<body>
    ...
    <div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <h1 class="text-white" data-aos="fade-right" data-aos-delay="150">MANILA STATION 2 TOUR PACKAGE
                    </h1>
                    ...
                    <div id="image" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner img-fluid">
                            <div class="carousel-item active">
                                <img src="images/manila2.jpg" alt="img" class="d-block w-100 img-thumbnail bg-dark"
                                    id='it-img'>
                            </div>
                            <div class="carousel-item">
                                <img src="images/manila3.jpg" alt="img" class="d-block w-100 img-thumbnail bg-dark"
                                    id='it-img'>
                            </div>
                            <div class="carousel-item">
                                <img src="images/manila4.jpg" alt="img"
                    ...
                    <div class='mt-5 mb-5 text-white'>
                        <p>
                        <h4> Welcome to the capital of the Philippines! Manila is an excellent hub to learn about the
                    ...
                    <div class=" mt-5 ">
                        <form action="/auth/register" method="post">
                            ...
                            <div class='form-outline mb-4'>
                                ...
                                <input type="text" placeholder="Destination" value="Manila" readonly class='form-control form-control-lg form-input'
                                    name="desPackage">
                            </div>
