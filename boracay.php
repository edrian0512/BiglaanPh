...
<body>
    ...
    <div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <h1 class="text-white" data-aos="fade-right" data-aos-delay="150">BORACAY STATION 2 TOUR PACKAGE
                    </h1>
                    ...
                    <div class='mt-5 mb-5 text-white'>
                        <p>
                        <h4> After its rehabilitation, Boracay reopens as pristine as ever. Fall in love with the
                            island’s
                            soft, white sand, crystal blue waters, and festive atmosphere that make Boracay one of the
                            top
                    ...
                    <div class=" mt-5 ">
                        <form action="/auth/register" method="post">
                            ...
                            <div class='form-outline mb-4'>
                                ...
                                <input type="text" placeholder="Destination" value="Boracay" readonly class='form-control form-control-lg form-input'
                                    name="desPackage">
                            </div>
