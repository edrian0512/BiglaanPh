...
<body>
    ...
    <div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <h1 class="text-white" data-aos="fade-right" data-aos-delay="150">PUERTO PRINCESA TOUR PACKAGE
                    </h1>
                    ...
                    <div id="image" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner img-fluid">
                            <div class="carousel-item active">
                                <img src="images/palawan1.jpg" alt="img" class="d-block w-100 img-thumbnail bg-dark"
                                    id='it-img'>
                            </div>
                            <div class="carousel-item">
                                <img src="images/palawan2.webp" alt="img" class="d-block w-100 img-thumbnail bg-dark"
                                    id='it-img'>
                            </div>
                            <div class="carousel-item">
                                <img src="images/palawan3.jpg" alt="img"
                    ...
                    <div id="Rates" class="tabcontent">
                        ...
                        <div class="itemHover">
                            <div
                                ...
                                <div class="d-flex flex-column">
                                    <h3 class="text-white ">A&A PLAZA HOTEL</h3>
                                    <img src="images/palawan-room1.jpg" width="200px" height="200px">
                                </div>
                                <div class="p-5 justify-content-center justify-content-center">
                                    <h2 class="text-white"> 01 Apr 2022 – 31 Mar 2023</h2>
                                    <br>
                                    <h3>Twin Sharing: Php3,200
                                    Single: Php4,821
                                    </h3>
                                </div>
                        ...
                        <div class="itemHover">
                            <div
                                class="d-flex flex-column flex-lg-row p-3 text-white flex-fill justify-content-lg-evenly justify-content-sm-evenly">
                                <div class="d-flex flex-column">
                                    <h3 class="text-white ">ASTORIA PALAWAN</h3>
                                    <img src="images/palawan-room2.jpg" width="200px" height="200px">
                                </div>
                                <div class="p-5 justify-content-center justify-content-center">
                                    <h2 class="text-white"> 01 Apr 2022 – 31 Mar 2023</h2>
                                    <br>
                                    <h3>Twin Sharing: Php5,789
                                    Single: Php10,000
                        ...
                        <div class="itemHover">
                            <div
                                class="d-flex flex-column flex-lg-row p-3 text-white flex-fill justify-content-lg-evenly justify-content-sm-evenly">
                                <div class="d-flex flex-column">
                                    <h3 class="text-white ">CANVAS BOUTIQUE HOTEL</h3>
                                    <img src="images/palawan-room3.jpg" width="200px" height="200px">
                                </div>
                                <div class="p-5 justify-content-center justify-content-center">
                                    <h2 class="text-white"> 01 Apr 2022 – 31 Mar 2023</h2>
                                    <br>
                        ...
                        <div class="itemHover">
                            <div
                                class="d-flex flex-column flex-lg-row p-3 text-white flex-fill justify-content-lg-evenly justify-content-sm-evenly">
                                <div class="d-flex flex-column">
                                    <h3 class="text-white ">CRYSTAL PARADISE</h3>
                                    <img src="images/palawan-room4.jpg" width="200px" height="200px">
                                </div>
                                <div class="p-5 justify-content-center justify-content-center">
                                    <h2 class="text-white">01 Apr 2022 – 31 May 2022
                                    </h2>
                                    <h3 class="text-white ">Twin Sharing: Php7,605
                                    Single: Php13,632</h3><br>
                        ...
                        <div class="itemHover">
                            <div
                                class="d-flex flex-column flex-lg-row p-3 text-white flex-fill justify-content-lg-evenly justify-content-sm-evenly">
                                <div class="d-flex flex-column">
                                    <h3 class="text-white ">EMPIRE SUITES</h3>
                                    <img src="images/palawan-room5.jpg" width="200px" height="200px">
                                </div>
                                <div class="p-5 justify-content-center justify-content-center">
                                    <h2 class="text-white">01 Jun 2022 – 15 Dec 2022
                                    </h2>
                                    <h3 class="text-white ">Twin Sharing: Php3,789
                                    Single: Php4,526
                        ...
                        <div class="itemHover">
                            <div
                                class="d-flex flex-column flex-lg-row p-3 text-white flex-fill justify-content-lg-evenly justify-content-sm-evenly">
                                <div class="d-flex flex-column">
                                    <h3 class="text-white ">GRANDE VISTA HOTEL</h3>
                                    <img src="images/palawan-room6.jpg" width="200px" height="200px">
                                </div>
                                <div class="p-5 justify-content-center justify-content-center">
                        ...
                        <div class="itemHover">
                            <div
                                class="d-flex flex-column flex-lg-row p-3 text-white flex-fill justify-content-lg-evenly justify-content-sm-evenly">
                                <div class="d-flex flex-column">
                                    <h4 class="text-white ">HOTEL FLEURIS</h4>
                                    <img src="images/palawan-room7.jpg" width="200px" height="200px">
                                </div>
                                <div class="p-5 justify-content-center justify-content-center">
                                    <h2 class="text-white">01 Apr 2022 – 15 Jun 2022
                                    </h2>
                                    <h3 class="text-white ">
                                        Twin Sharing: Php3,311
                                        Single: Php5,042
                        ...
                        <div class="itemHover">
                            <div
                                class="d-flex flex-column flex-lg-row p-3 text-white flex-fill justify-content-lg-evenly justify-content-sm-evenly">
                                <div class="d-flex flex-column">
                                    <h3 class="text-white z">HUE HOTELS & RESORTS </h3>
                                    <img src="images/palawan-room8.jpg" width="200px" height="200px">
                                </div>
                                <div class="p-5 justify-content-center justify-content-center">
                        ...
                        <div class="itemHover">
                            <div
                                class="d-flex flex-column flex-lg-row p-3 text-white flex-fill justify-content-lg-evenly justify-content-sm-evenly">
                                <div class="d-flex flex-column">
                                    <h3 class="text-white ">IPIL SUITES</h3>
                                    <img src="images/palawan-room9.jpg" width="200px" height="200px">
                                </div>
                                <div class="p-5 justify-content-center justify-content-center">
                        ...
                        <div class="itemHover">
                            <div
                                class="d-flex flex-column flex-lg-row p-3 text-white flex-fill justify-content-lg-evenly justify-content-sm-evenly">
                                <div class="d-flex flex-column">
                                    <h3 class="text-white ">ONE MANALO PLACE</h3>
                                    <img src="images/palawan-room10.jpg" width="200px" height="200px">
                                </div>
                                <div class="p-5 justify-content-center justify-content-center">
                                    <h2 class="text-white">01 Apr 2022 – 31 Mar 2023
            ...
            <div class="col-lg-3">
                <div
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <a href="palawan.php" class='text-decoration-none'>
