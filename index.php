...
<body>
    ...
    <section class="home" id="home">
        ...
        <div class="content">
            ...
            <a data-aos="fade-up" data-aos-delay="600" href="#destination" class="btn">Book Now</a>
        </div>
    ...
    <section class="destination" id="destination">
        ...
        <div class="box-container">
            ...
            <div class="box" data-aos="fade-up" data-aos-delay="150">
                ...
                <div class="content">
                    <h3>Boracay</h3>
                    <a href="boracay.php">View Itinerary <i class="fas fa-angle-right"></i></a>
                </div>
            </div>

            <div class="box" data-aos="fade-up" data-aos-delay="300">
                <div class="image">
                    <img src="images/designation2.jpg" alt="img">
                </div>
                <div class="content">
                    <h3>Cebu</h3>
            ...
            <div class="box" data-aos="fade-up" data-aos-delay="600">
                <div class="image">
                    <img src="images/designation4.jpg" alt="img">
                </div>
                <div class="content">
                    <h3>Siargao</h3>
            ...
            <div class="box" data-aos="fade-up" data-aos-delay="750">
                <div class="image">
                    <img src="images/designation5.jpg" alt="img" height="300px">
                </div>
                <div class="content">
                    <h3>Bicol</h3>
                    <a href="itenerary.php">View Itinerary <i class="fas fa-angle-right"></i></a>
            ...
            <div class="box" data-aos="fade-up" data-aos-delay="900">
                <div class="image">
                    <img src="images/designation6.jpg" alt="img">
                </div>
                <div class="content">
                    <h3>Mindoro</h3>
                    <a href="itenerary.php">View Itinerary <i class="fas fa-angle-right"></i></a>
            ...
            <div class="box" data-aos="fade-up" data-aos-delay="1150">
                <div class="image">
                    <img src="images/designation7.png" alt="img">
                </div>
                <div class="content">
                    <h3>Bataan</h3>
                    <a href="itenerary.php">View Itinerary <i class="fas fa-angle-right"></i></a>
            ...
            <div class="box" data-aos="fade-up" data-aos-delay="1300">
                <div class="image">
                    <img src="images/designation8.jpeg" alt="img">
                </div>
                <div class="content">
                    <h3>Ilocos Norte</h3>
                    <a href="itenerary.php">View Itinerary <i class="fas fa-angle-right"></i></a>
            ...
            <div class="box" data-aos="fade-up" data-aos-delay="1300">
                <div class="image">
                    <img src="images/designation9.jpg" alt="img">
                </div>
                <div class="content">
                    <h3>Ilocos Sur</h3>
                    <a href="itenerary.php">View Itinerary <i class="fas fa-angle-right"></i></a>
            ...
            <div class="box" data-aos="fade-up" data-aos-delay="1300">
                <div class="image">
                    <img src="images/designation10.jpg" alt="img">
                </div>
                <div class="content">
                    <h3>Manila</h3>
                    <a href="itenerary.php">View Itinerary <i class="fas fa-angle-right"></i></a>
    ...
    <section class="gallery" id="gallery">
        ...
        <div class="box-container">
            ...
            <div class="box" data-aos="zoom-in-up" data-aos-delay="150">
                <img src="images/palawan1.jpg" alt="img" height="555px">
                <span>travel spot</span>
                <h3>Palawan Underground River</h3>
            </div>

            <div class="box" data-aos="zoom-in-up" data-aos-delay="300">
                <img src="images/bicolCagsawa.jpg" alt="img" height="300px">
                <span>travel spot</span>
                <h3>Bicol Cagsawa Ruins</h3>
            </div>

            <div class="box" data-aos="zoom-in-up" data-aos-delay="450">
                <img src="images/siargao1.jpg" alt="img" height="600px">
                <span>travel spot</span>
                <h3>Siargao</h3>
            </div>

            <div class="box" data-aos="zoom-in-up" data-aos-delay="150">
                <img src="images/bohol3.jfif" alt="img" height="300px">
                <span>travel spot</span>
                <h3>Bohol Chocolate Hills</h3>
            </div>

            <div class="box" data-aos="zoom-in-up" data-aos-delay="300">
                <img src="images/cebu1.jpg" alt="img" height="555px">
                <span>travel spot</span>
                <h3>Cebu</h3>
            </div>

            <div class="box" data-aos="zoom-in-up" data-aos-delay="450">
                <img src="images/baguio2.jpg" alt="img" height="300px">
                <span>travel spot</span>
                <h3>Baguio</h3>
            </div>

            <div class="box" data-aos="zoom-in-up" data-aos-delay="150">
                <img src="images/bora1.webp" alt="img" height="555px">
                <span>travel spot</span>
                <h3>Boracay</h3>
            </div>

            <div class="box" data-aos="zoom-in-up" data-aos-delay="300">
                <img src="images/Samal.jpg" alt="img" height="300px">
                <span>travel spot</span>
                <h3>Davao Samal Island</h3>
            </div>

            <div class="box" data-aos="zoom-in-up" data-aos-delay="450">
                <img src="images/mtPulag.jpg" alt="img" height="600px">
                <span>travel spot</span>
    ...
    <section class="review">
        ...
        <div class="box-container" data-aos="fade-left" data-aos-delay="200">

            <div class="box">
                <p>“Booking through you was very easy and made our lives so much easier."</p>
                <div class="user">
            ...
            <div class="box">
                <p>Thank you so much for being proactive (awesome memory, by the way).</p>
                <div class="user">
                    <img src="images/testi2.jpeg" alt="img">
                    <div class="info">
                        <h3>Mark V</h3>
                        <span>Designer</span>
                    </div>
            ...
            <div class="box">
                <p>thank you so much for a well organized trip. We had a wonderful time. </p>
                <div class="user">
                    <img src="images/testi3.jpg" alt="img">
                    <div class="info">
                        <h3>Carl M</h3>
                        <span>Engineer</span>
                    </div>
            ...
            <div class="box">
                ...
                <div class="user">
                    <img src="images/testi4.jpg" alt="img">
                    <div class="info">
                        <h3>Lance O</h3>
                        <span>Developer</span>
                    </div>
    ...
    <div class="banner">
        ...
        <div class="content" data-aos="zoom-in-up" data-aos-delay="300">
            ...
            <a href="#destination" class="btn">book now</a>
        </div>
