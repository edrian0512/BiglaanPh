...
<body>
    ...
    <header class="header">
        ...
        <a data-aos="zoom-in-left" data-aos-delay="150" href="#" class="logo"> <i class="fas fa-paper-plane"></i>
            Biglaan <span style='color:#29d9d5'>PH</span></a>
    ...
    <section class="home" id="home">
        ...
        <div class="content">
            ...
            <p data-aos="fade-up" data-aos-delay="450">“Don’t travel just to see. Travel to try, listen, feel, taste.
                That way there won’t be any place you cannot find beauty.”</p>
    ...
    <section class="about" id="about">
        ...
        <div class="content" data-aos="fade-left" data-aos-delay="600">
            ...
            <p>Relax and let someone else handle all the details of planning your trip. We take care of organising
                everything for you, from route planning to making bookings, so you save time and effort. You can look
                forward to your tour knowing that the experts have everything in hand.</p>
    ...
    <section class="destination" id="destination">
        ...
        <div class="box-container">
            ...
            <div class="box" data-aos="fade-up" data-aos-delay="150">
                ...
                <div class="content">
                    <h3>Boracay</h3>
                    <p>After its rehabilitation, Boracay reopens as pristine as ever. Fall in love with the island’s
                        soft, white sand, crystal blue waters, and festive atmosphere that make Boracay one of the top
                        tourist destinations of the Philippines.
                    </p>
                    <a href="itinerary.php">View Itinerary <i class="fas fa-angle-right"></i></a>
                </div>
            </div>
            ...
            <div class="box" data-aos="fade-up" data-aos-delay="300">
                ...
                <div class="content">
                    <h3>Cebu</h3>
                    <p>The spotlight is on the majestic island province of Cebu as a highly-urbanized destination rich
                        in historical, cultural, and religious sites.</p>
                    <br> <br> <br>
            ...
            <div class="box" data-aos="fade-up" data-aos-delay="450">
                ...
                <div class="content">
                    <h3>Palawan</h3>
                    <p>The most beautiful place according to renowned French explorer Jacques Costeau, Palawan is home
                        to awe-inspiring paradise islands and islets that transport you to a fantasy world.</p>
            ...
            <div class="box" data-aos="fade-up" data-aos-delay="600">
                ...
                <div class="content">
                    <h3>Siargao</h3>
                    <p>Head over to the surf capital of the Philippines and venture into the great outdoors with
                        Siargao! Named Best Island in Asia by Condé Nast Traveler in 2019</p>
            ...
            <div class="box" data-aos="fade-up" data-aos-delay="750">
                ...
                <div class="content">
                    <h3>Bicol</h3>
                    <p>It's not just home to the world-famous Mayon Volcano. The Bicol Region has practically everything
                        you could ask for: delicious cuisine, stunning landscapes, and the friendliest smiles you'll
                        encounter.</p>
                    <br> <br><a href="itenerary.php">View Itinerary <i class="fas fa-angle-right"></i></a>
                </div>
            </div>
            ...
            <div class="box" data-aos="fade-up" data-aos-delay="900">
                ...
                <div class="content">
                    <h3>Mindoro</h3>
                    <p>When talking about the province of Mindoro, the famous Puerto Galera comes to mind. But the
                        province has more to offer than its world-renowned beach such as heritage tours, farm tourism,
                        and nature-based wellness activities.</p>
                    <a href="itenerary.php">View Itinerary <i class="fas fa-angle-right"></i></a>
                </div>
            </div>
            ...
            <div class="box" data-aos="fade-up" data-aos-delay="1150">
                ...
                <div class="content">
                    <h3>Bataan</h3>
                    <p>Discover the magic in this amazing historical and cultural province, only an hour by ferryboat
                        across the bay from Manila.</p>
                    <br> <br> <br> <br> <br> <a href="itenerary.php">View Itinerary <i
            ...
            <div class="box" data-aos="fade-up" data-aos-delay="1300">
                ...
                <div class="content">
                    <h3>Ilocos Norte</h3>
                    <p>Take your pick among the different adventures that await you at Ilocos Norte! Exploring the
                        province is best by land to get the most out of its stunning topography and picturesque views.
                    </p>
            ...
            <div class="box" data-aos="fade-up" data-aos-delay="1300">
                ...
                <div class="content">
                    <h3>Ilocos Sur</h3>
                    <p>Visiting Ilocos Sur is like traveling back in time, with its various churches, buildings, and
                        even entire cities seemingly taken out of the Spanish era.</p>
            ...
            <div class="box" data-aos="fade-up" data-aos-delay="1300">
                ...
                <div class="content">
                    <h3>Manila</h3>
                    <p>Welcome to the capital of the Philippines! Manila is an excellent hub to learn about the
                        country's culture and history. The metro offers various attractions that make it the perfect
                        spot for staycations!
                    </p>
                    <br> <a href="itenerary.php">View Itinerary <i class="fas fa-angle-right"></i></a>
                </div>
            </div>
    ...
    <section class="review">
        ...
        <div class="box-container" data-aos="fade-left" data-aos-delay="600">
            ...
            <div class="box">
                <p>“Booking through you was very easy and made our lives so much easier. I have nothing bad to say!
                    Thank you for giving us tips and guidance before we left on what to bring and such, that was very
                    helpful! Thanks again, Meg S."</p>
                <div class="user">
            ...
            <div class="box">
                <p>Thank you so much for being proactive (awesome memory, by the way). Maybe it seems like no big deal
                    to you but this is amazing customer service and is greatly appreciated.</p>
                <div class="user">
            ...
            <div class="box">
                <p>thank you so much for a well organized trip. We had a wonderful time. Hard to believe it's already
                    done and past. Weather was awesome, the hotels were nice, thank you for everything!</p>
                <div class="user">
