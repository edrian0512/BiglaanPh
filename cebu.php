...
<body>
    ...
    <div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <h1 class="text-white" data-aos="fade-right" data-aos-delay="150">CEBU TOUR PACKAGE
                    </h1>
                    ...
                    <div id="image" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner img-fluid">
                            <div class="carousel-item active">
                                <img src="images/cebu2.jpg" alt="img" class="d-block w-100 img-thumbnail bg-dark"
                                    id='it-img'>
                            </div>
                            <div class="carousel-item">
                                <img src="images/cebu3.jpg" alt="img" class="d-block w-100 img-thumbnail bg-dark"
                                    id='it-img'>
                            </div>
                            <div class="carousel-item">
                                <img src="images/cebu4.jpg" alt="img"
                    ...
                    <div class='mt-5 mb-5 text-white'>
                        <p>
                        <h4> The spotlight is on the majestic island province of Cebu as a highly-urbanized destination rich in historical, cultural, and religious sites. Initially, only Cebu City and Lapu-Lapu City were allowed to accept tourists, but on February 22, 2021, the entire province was reopened for domestic tourists. So take a break from the ordinary, and taste and see Cebu’s many wonders—from its delightful Cebu lechon baboy to the Shrine of Lapu-Lapu.
                    ...
                    <div id="Rates" class="tabcontent">
                        ...
                        <div class="itemHover mt-5">
                            <div
                                ...
                                <div class="d-flex flex-column align-content-center">
                                    <h3 class="text-white ">ALLURE HOTEL & SUITES</h3>
                                    <img src="images/cebu-room1.jpg" width="200px" height="200px">
                                </div>
                                <div class="p-5 justify-content-center justify-content-center">
                                    <h2 class="text-white">15 Jun 2022 – 30 Oct 2023</h2>
                                    <h3 class="text-white ">Twin Sharing: Php4,051
                                        Single: Php6,522</h3><br>
                                    <h3>
                        ...
                        <div class="itemHover">
                            <div
                                class="d-flex flex-column flex-lg-row p-3 text-white flex-fill justify-content-lg-evenly justify-content-sm-evenly">
                                <div class="d-flex flex-column align-content-center">
                                    <h3 class="text-white ">BADIAN ISLAND RESORT</h3>
                                    <img src="images/cebu-room2.jpg" width="200px" height="200px">
                                </div>
                                <div class="p-5 justify-content-center justify-content-center">
                                    <h2 class="text-white">01 Apr 2022 – 31 May 2023
                                    </h2>
                                    <h3 class="text-white ">Twin Sharing: Php15,368
                                        Single: Php29,158</h3><br>
                                    <h3>
                        ...
                        <div class="itemHover">
                            <div
                                ...
                                <div class="d-flex flex-column">
                                    <h3 class="text-white ">BLUEWATER MARIBAGO</h3>
                                    <img src="images/cebu-room3.jpg" width="200px" height="200px">
                                </div>
                                <div class="p-5 justify-content-center justify-content-center">
                                    <h2 class="text-white"> 01 Apr 2022 – 31 Mar 2023</h2>
                                    <br>
                                    <h3>Twin Sharing: Php8,632
                                        Single: Php15,684
                        ...
                        <div class="itemHover">
                            <div
                                class="d-flex flex-column flex-lg-row p-3 text-white flex-fill justify-content-lg-evenly justify-content-sm-evenly">
                                <div class="d-flex flex-column">
                                    <h3 class="text-white ">BLUEWATER SUMILON</h3>
                                    <img src="images/cebu-room4.jpg" width="200px" height="200px">
                                </div>
                                <div class="p-5 justify-content-center justify-content-center">
                                    <h2 class="text-white">01 Apr 2022 – 31 May 2022
                                    </h2>
                                    <h3 class="text-white ">Twin Sharing: Php21,579
                                        Single: Php41,579</h3><br>
                        ...
                        <div class="itemHover">
                            <div
                                class="d-flex flex-column flex-lg-row p-3 text-white flex-fill justify-content-lg-evenly justify-content-sm-evenly">
                                <div class="d-flex flex-column">
                                    <h3 class="text-white ">CEBU NORTHWINDS</h3>
                                    <img src="images/cebu-room5.jpg" width="200px" height="200px">
                                </div>
                                <div class="p-5 justify-content-center justify-content-center">
                                    <h2 class="text-white">01 Jun 2022 – 15 Dec 2022
                                    </h2>
                                    <h3 class="text-white ">Twin Sharing: Php4,168
                                        Single: Php6,758
                        ...
                        <div class="itemHover">
                            <div
                                class="d-flex flex-column flex-lg-row p-3 text-white flex-fill justify-content-lg-evenly justify-content-sm-evenly">
                                <div class="d-flex flex-column">
                                    <h3 class="text-white ">COCONUT PENSION</h3>
                                    <img src="images/cebu-room8.jpg" width="200px" height="200px">
                                </div>
                                <div class="p-5 justify-content-center justify-content-center">
                        ...
                        <div class="itemHover">
                            <div
                                class="d-flex flex-column flex-lg-row p-3 text-white flex-fill justify-content-lg-evenly justify-content-sm-evenly">
                                <div class="d-flex flex-column">
                                    <h4 class="text-white ">COSTABELLA RESORT</h4>
                                    <img src="images/cebu-room6.jpg" width="200px" height="200px">
                                </div>
                                <div class="p-5 justify-content-center justify-content-center">
                                    <h2 class="text-white">01 Apr 2022 – 15 Jun 2022
                                    </h2>
                                    <h3 class="text-white ">
                                        Twin Sharing: Php8,526
                                        Single: Php14,737
                        ...
                        <div class="itemHover">
                            <div
                                class="d-flex flex-column flex-lg-row p-3 text-white flex-fill justify-content-lg-evenly justify-content-sm-evenly">
                                <div class="d-flex flex-column">
                                    <h3 class="text-white z">CROWN REGENCY HOTEL </h3>
                                    <img src="images/cebu-room7.jpg" width="200px" height="200px">
                                </div>
                                <div class="p-5 justify-content-center justify-content-center">
                        ...
                        <div class="itemHover">
                            <div
                                class="d-flex flex-column flex-lg-row p-3 text-white flex-fill justify-content-lg-evenly justify-content-sm-evenly">
                                <div class="d-flex flex-column">
                                    <h3 class="text-white ">CROWN REGENCY SUITES</h3>
                                    <img src="images/cebu-room9.jpg" width="200px" height="200px">
                                </div>
                                <div class="p-5 justify-content-center justify-content-center">
                        ...
                        <div class="itemHover">
                            <div
                                class="d-flex flex-column flex-lg-row p-3 text-white flex-fill justify-content-lg-evenly justify-content-sm-evenly">
                                <div class="d-flex flex-column">
                                    <h3 class="text-white ">HOTEL ELIZABETH</h3>
                                    <img src="images/cebu-room10.jpg" width="200px" height="200px">
                                </div>
                                <div class="p-5 justify-content-center justify-content-center">
                                    <h2 class="text-white">01 Apr 2022 – 31 Mar 2023
                    ...
                    <div id="Inclusion" class="tabcontent">
                        <h3 class="text-white mt-5">
                            ...
                            Round trip Cebu airport transfers</h3>
                    </div>
                </div>
                    ...
                    <div class=" mt-5 ">
                        <form action="/auth/register" method="post">
                            ...
                            <div class='form-outline mb-4'>
                                ...
                                <input type="text" placeholder="Destination" value="Cebu" readonly class='form-control form-control-lg form-input'
                                    name="desPackage">
                            </div>
            ...
            <div class="col-lg-3">
                <div
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <a href="cebu.php" class='text-decoration-none'>
