            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div id="image" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner img-fluid">
                            <div class="carousel-item active">
                                <img src="images/bataan2.jpg" alt="img" class="d-block w-100 img-thumbnail bg-dark"
                                    id='it-img'>
                            </div>
                            <div class="carousel-item">
                                <img src="images/bataan3.jpg" alt="img" class="d-block w-100 img-thumbnail bg-dark"
                                    id='it-img'>
                            </div>
                            <div class="carousel-item">
                                <img src="images/bataan4.jpg" alt="img"
                    ...
                    <div class='mt-5 mb-5 text-white'>
                        <p>
                        <h4> Discover the magic in this amazing historical and cultural province, only an hour by ferryboat
                    ...
                    <div class=" mt-5 ">
                        <form action="/auth/register" method="post">
                            ...
                            <div class='form-outline mb-4'>
                                ...
                                <input type="text" placeholder="Destination" value="Bataan" readonly class='form-control form-control-lg form-input'
                                    name="desPackage">
                            </div>
