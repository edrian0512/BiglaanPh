...
<body>
    ...
    <div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <h1 class="text-white" data-aos="fade-right" data-aos-delay="150">BAGUIO CITY TOUR PACKAGE
                    </h1>
                    ...
                    <div id="image" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner img-fluid">
                            <div class="carousel-item active">
                                <img src="images/baguio4.jpg" alt="img" class="d-block w-100 img-thumbnail bg-dark"
                                    id='it-img'>
                            </div>
                            <div class="carousel-item">
                                <img src="images/baguio3.jpg" alt="img" class="d-block w-100 img-thumbnail bg-dark"
                                    id='it-img'>
                            </div>
                            <div class="carousel-item">
                                <img src="images/baguio1.jpg" alt="img" class="d-block w-100 img-thumbnail bg-dark"
                                    id='it-img'>
                            </div>
                        </div>
                    ...
                    <div class=" mt-5 ">
                        <form action="/auth/register" method="post">
                            ...
                            <div class='form-outline mb-4'>
                                ...
                                <input type="text" placeholder="Destination" value="Baguio" readonly
                                    class='form-control form-control-lg form-input' name="desPackage">
                            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                <div
                    ...
                    <div class="d-flex flex-column">
                        <img src="images/bora1.webp"><br>
                        <a href="boracay.php" class='text-decoration-none'>
                            <h2 class='mt-3 btn-form'>Boracay</h2>
                        </a>
                    </div>
                </div>
            </div>
